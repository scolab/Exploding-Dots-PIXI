...
export default class PowerZone extends PIXI.Container {
  ...
  checkDivideResultText(doCheck) {
    ...
    if (this.positiveDividerText != null && this.negativeDividerText != null) {
      if (doCheck) {
        ...
        const negativeDividerIsEmpty = this.getDividerTextStatus(this.negativeDividerText, !dividerIsEmpty);
  ...
  removeDotsIfNeeded(storeHash, isPositive) {
    ...
    } else if (Object.keys(this.negativeDots).length + Object.keys(this.negativeDotNotDisplayed).length > Object.keys(storeHash).length) {
